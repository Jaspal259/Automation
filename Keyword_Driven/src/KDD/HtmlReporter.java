...
public class HtmlReporter {
	...
	public static String captureScreenshot(String uploadPath){
		...
		File scrFile = ((TakesScreenshot)resusableFuction.driver).getScreenshotAs(OutputType.FILE);
	...
	public void prepareNewReport(String reportName){
							...
							try{
								reportFileName = reportPath +"_" + (new Date()).toString().replace(":", "-") + ".html";
								fstream = new FileWriter(reportFileName ,false); //false : Overrite the existing file
